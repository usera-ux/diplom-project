...
<path d="M10 5.5C10.2416 5.5 10.4375 5.69588 10.4375 5.9375C10.4375 6.17912 10.2416 6.375 10 6.375C9.75838 6.375 9.5625 6.17912 9.5625 5.9375C9.5625 5.69588 9.75838 5.5 10 5.5Z" fill="#111D33" stroke="#111D33"/>
<path d="M10 14.375C11.3807 14.375 12.5 13.2557 12.5 11.875C12.5 10.4943 11.3807 9.375 10 9.375C8.61929 9.375 7.5 10.4943 7.5 11.875C7.5 13.2557 8.61929 14.375 10 14.375Z" stroke="#111D33" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
  tablet: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3.125 13.75V5.625C3.125 5.29348 3.2567 4.97554 3.49112 4.74112C3.72554 4.5067 4.04348 4.375 4.375 4.375H15.625C15.9565 4.375 16.2745 4.5067 16.5089 4.74112C16.7433 4.97554 16.875 5.29348 16.875 5.625V13.7五十V五点六二五C三点一二五 四点二九三四八 四点二五六七 四点九七五五四 四点四九一一二 四点七四一一二C三点七二五五四 四点五零六七 四点零四三四五 四点三七五 四点三七五 四点三七五H十五点六二五C十五点九五六五 四点三七五 十六点二七四五 四点五零六七 十六点五零八九 四点七四一一二C十六点七四三三 四点九七五五四 十六点八七五 六點二九三四五 十六點八七五 六點六二五V十三點七五十V十三點七八V十三點七八V十三點七八V十三點七八V十三點七八V十三點七八V十三點七八V十三點七八V十三點七八V十三點七八V thirteen.points.seven-five
</svg>
`,
}
...
export const useCatalogueStore = defineStore('catalogue', () => {
  ...
  async function fetchCategories() {
    ...
    // Подставляем SVG по ключу из поля icon
  ...
  async function fetchStories() {
    ...
    // Адаптируем под формат, который ожидает шаблон (поле svg)
  ...
  async function fetchProducts(categoryId) {
    ...
    const { data, error: err } = await supabase
      ...
      .select('*')
      .order('id')
    // Если у тебя появится category_id — добавь: .eq('category_id', categoryId)
  ...
  return { products, categories, stories, loading, error, fetchCategories, fetchStories, fetchProducts }
})